...
from pet_products_scraper import (PetPlanetETL, PetProductsETL, PetsAtHomeETL,
                                  ZooplusETL, utils)
...
parser.add_argument(
    "task",
    choices=["get_links", "scrape"],
    help="Identify the task to be executed. get_links=get links from registered shops; scrape=scrape products.",
)
parser.add_argument(
    "-s",
    "--shop",
    choices=["Zooplus", "PetsAtHome", "PetPlanet"],
